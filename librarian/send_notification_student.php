                    ...
                    <div class="x_content">
                        ...
                        <form name="form1" action="" method="post" class="col-lg-6" enctype="multipart/formdata">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td><textarea class="form-control" name="msg" placeholder="Enter your message here"></textarea></td>
                                </tr>
                                <tr>
                                    <td><input type="submit" name="submit1" value="Send Message" class="form-control btn btn-default"></td>
                                </tr>
